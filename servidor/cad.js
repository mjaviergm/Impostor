...
//// funciones genéricas
	...
	this.connect=function(callback){
		    var cad=this;		
		    //clase:papauma@cluster0.yyeaj.mongodb.net/impostorclass?retryWrites=true&w=majority
			mongo.connect("mongodb+srv:clase:papauma@cluster0.yyeaj.mongodb.net/impostorclass?retryWrites=true&w=majority",{useUnifiedTopology: true },function(err, database){
	            if (err){
